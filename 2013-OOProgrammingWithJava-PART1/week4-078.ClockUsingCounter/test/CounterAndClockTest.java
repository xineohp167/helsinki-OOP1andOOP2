...
public class CounterAndClockTest {
    ...
    public void noExceptionInMain() {
        ...
        assertFalse("main-method thoud not throw exception! please remove from the definition: " + virhe, m.toString().contains("throws"));
    }
    ...
    public void exactClockAdvances() {
        ...
        assertFalse("Da a clock as defined by the assignment 78.4 "
                + "With input 50 59 23 the first printed clock value should be 23:59:50", eka == -1);

        assertTrue("Da a clock as defined by the assignment 78.4 "
