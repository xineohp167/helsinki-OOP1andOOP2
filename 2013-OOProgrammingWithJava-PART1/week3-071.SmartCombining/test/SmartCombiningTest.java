    ...
    public void tarkistaLista(ArrayList<Integer> lista1, ArrayList<Integer> lista2) {
        ...
        for (int i=0; i<yKopy.size()-1; i++) {
            if ( yKopy.get(i)==yKopy.get(i+1))
                 fail("Combination of lists " + origLista1 + " and " + origLista2 + " has twice the number " + yKopy.get(i) + ".");
        }
        
        for (int luku : origLista1) {
            if (!yhdiste.contains(luku)) {

                fail("Combination of lists " + origLista1 + " and " + origLista2 + " should contain the number " + luku + ".");
            }
        ...
        if (!yhdiste.isEmpty()) {
            fail("ListCombination of lists " + origLista1 + " and " + origLista2 + " should not contain following " + yhdiste + ".");
        }
