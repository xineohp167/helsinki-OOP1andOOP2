...
public class B_Test<_Tileja, _Account> {
    ...
    public void testaaToString() throws Exception {
        ...
        expectNew(Account.class, EasyMock.anyObject(), EasyMock.eq(100.0)).andReturn(a);
        expectNew(Account.class, EasyMock.anyObject(), EasyMock.eq(0.0)).andReturn(b);
        expectNew(Account.class, EasyMock.anyObject(), EasyMock.eq(0.0)).andReturn(c);
