...
public class DictionaryTest {
    ...
    public void hasHashMap() {
        ...
        assertTrue("Class " + klassName + " should have an instance variable of type HashMap<String, String>", kentat[0].toString().contains("HashMap"));
    }
    ...
    public void methodTranslationList() throws Throwable {
        ...
        assertTrue("Create method public ArrayList<String> " + metodi + "() for class " + klassName,
                klass.method(olio, metodi)
