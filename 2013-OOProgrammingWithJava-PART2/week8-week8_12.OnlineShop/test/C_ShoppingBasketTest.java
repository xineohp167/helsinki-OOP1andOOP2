...
public class C_ShoppingBasketTest {
    ...
    public void hasMapOrList() {
        ...
        for (Field field : kentat) {
            ...
            assertFalse(k
                    + "so change " + kentta(field.toString()) + " to the correct type", field.toString().contains("ArrayList"));

            assertFalse(k + " you don't need any other instance variables, remove " + kentta(field.toString()), !field.toString().contains("Map") && !field.toString().contains("List"));
