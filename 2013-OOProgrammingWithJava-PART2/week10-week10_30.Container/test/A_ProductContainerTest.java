...
public class A_ProductContainerTest {
    ...
    public void productContainerToString() throws Throwable {
        Object tv = newProductContainer("suklaa", 10.0);
        String mj = tv.toString();
        assertTrue("Overwrite method toString in class ProductContainer as specified in the assignment", mj.contains("suklaa"));
    }
    ...
    public void productContainerToStringOK1() throws Throwable {
        ...
        String k = "try \ntv = new ProductContainer(\"suklaa\",10); \n"
                + "tv.addToTheContainer(5); \n"
                + "System.out.print(tv);\n";
        assertEquals(v+"\n"+k+"\n","suklaa: volume = 5.0, space 5.0", mj);
    }

    @Test
    @Points("30.2")
    public void productContainerToStringOK2() throws Throwable {
        Object tv = newProductContainer("sinappi", 15.0);
        ((containers.Container) tv).addToTheContainer(10);
        String mj = tv.toString();
        String v = "Does the ProductContainer's method toString work as specified in the assignment? ";
        String k = "try \ntv = new ProductContainer(\"sinappi\",15); tv.addToTheContainer(10);\n"
                + "System.out.print(tv);\n";
        assertEquals(v+"\n"+k+"\n","sinappi: volume = 10.0, space 5.0", mj);
    }
